...
import { Box, Paper, Typography, TextField, Button, Stack, Modal } from "@mui/material";
...
function UpdateCustomer(
  { customerId: propId, onCustomerUpdated, onCancel, open }: UpdateCustomerProps = { open: false }
) {
